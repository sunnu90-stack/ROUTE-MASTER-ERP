...
class MitraApp extends StatelessWidget {
  const MitraApp({Key? key}) : super(key: key);
      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Color(0xFF1A0A3E), MitraColors.indigo, Color(0xFF0F2A1A)],
          ),
        ),
        child: Column(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      _buildRoleButton('Student', '🎒', isStudent, () {
                        setState(() => isStudent = true);
                      }),
                      const SizedBox(width: 8),
                      _buildRoleButton('Teacher', '👩‍🏫', !isStudent, () {
                  ...
                  Container(
                    ...
                    child: Row(
                      children: const [
                        ...
                        Text(
                          'OTP sent via WhatsApp to +91 987XX',
                          style: TextStyle(
                            fontSize: 11,
  ...
  Widget _buildOtpBox(String val, bool filled) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: MitraColors.bgCard,
        border: Border.all(
          color: filled ? MitraColors.saffron : MitraColors.border,
          width: 2,
        ),
        borderRadius: BorderRadius.circular(10),
      ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            meta,
            style: const TextStyle(fontSize: 10, color: MitraColors.textMuted),
          ),
        ],
      ),
    );
